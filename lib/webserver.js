...
<head>
  ...
  <style nonce="${nonce}">
    ...
    *{box-sizing:border-box}html,body{min-height:100%;margin:0}body{font-family:Inter,ui-sans-serif,system-ui,-apple-system,BlinkMacSystemFont,"Segoe UI",sans-serif;background:linear-gradient(135deg,var(--bg),var(--bg2));color:var(--text);overflow-x:hidden}
    ...
    <section class="shell" aria-labelledby="auth-title">
      <aside class="story">
        <div>
          ...
          <div class="story-main"><div class="eyebrow"><i></i>Identity protection layer</div><h1>\u8BA9\u6BCF\u4E00\u6B21\u8BBF\u95EE\u90FD<br><span class="gradient">\u6709\u8EAB\u4EFD\u3001\u6709\u8FB9\u754C\u3002</span></h1><p class="lead">\u8BA4\u8BC1\u53D1\u751F\u5728 Harness\u3001\u63D2\u4EF6\u8D44\u6E90\u3001RPC \u4E0E WebSocket \u4E4B\u524D\u3002\u672A\u7ECF\u6388\u6743\u7684\u8BF7\u6C42\u4E0D\u4F1A\u89E6\u8FBE\u5DE5\u4F5C\u533A\u6216\u4F1A\u8BDD\u6570\u636E\u3002</p><div class="features"><div class="feature"><b>\u670D\u52A1\u5668\u7AEF\u4F1A\u8BDD</b><span>Opaque token \u53EF\u64A4\u9500\uFF0C\u4E0D\u5199\u5165\u6D4F\u89C8\u5668\u5B58\u50A8\u3002</span></div><div class="feature"><b>\u5168\u94FE\u8DEF\u95E8\u7981</b><span>HTTP\u3001RPC \u4E0E\u5B9E\u65F6\u8FDE\u63A5\u7EDF\u4E00\u6821\u9A8C\u3002</span></div><div class="feature"><b>\u9ED8\u8BA4\u9501\u5B9A</b><span>\u672A\u521D\u59CB\u5316\u4E0E\u6545\u969C\u72B6\u6001\u7EDD\u4E0D\u533F\u540D\u653E\u884C\u3002</span></div><div class="feature"><b>\u5B89\u5168\u5BA1\u8BA1</b><span>\u5173\u952E\u8BA4\u8BC1\u4E8B\u4EF6\u5F62\u6210\u53EF\u8FFD\u6EAF\u8BB0\u5F55\u3002</span></div></div></div>
        </div>
